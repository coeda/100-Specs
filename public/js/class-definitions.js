 ...
 *
 */
var farTooTallAStory = new House(100).isATallStory(10);
 ...
 *
 */
var badForYou = new Meal(['chips', 'food']).containsJunkFood();
var goodForYou = new Meal(['fruits', 'vegetables']).containsJunkFood();
